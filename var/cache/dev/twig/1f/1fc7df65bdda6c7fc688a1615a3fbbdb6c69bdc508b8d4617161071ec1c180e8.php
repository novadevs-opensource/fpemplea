...
class __TwigTemplate_20600bfb96b0a4178d9cf76fca1d0a78dc1febd43e33302e4561c832c2352f9f extends Twig_Template
{
...
<div id=\"empresas\" class=\"tab-pane fade in\">
    ...
    <div class=\"form-group\">
        ...
        ";
        // line 20
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "termsAccepted", array()), 'row', array("id" => "company_terms_accepted", "attr" => array("class" => "la_prueba")));
        echo "
        ";
        // line 21
