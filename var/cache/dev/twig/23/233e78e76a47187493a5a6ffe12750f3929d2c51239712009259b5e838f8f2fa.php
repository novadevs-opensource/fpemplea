...
class __TwigTemplate_09f8febe2f64c80b7bf11d0096cceec68285bd37073c24b16d07298cbaa8bfe1 extends Twig_Template
{
...
<div id=\"schoolReg\" class=\"\">
    ";
        // line 3
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock(($context["form"] ?? $this->getContext($context, "form")), 'form_start', array("attr" => array("id" => "school_reg")));
        echo "
      <div class=\"form-group\">
        <hr>
        ";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "role", array()), 'row', array("attr" => array("class" => "hidden", "value" => "ROLE_SCHOOL")));
        echo "
        ";
        // line 7
        ...
        ";
        // line 21
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($this->getAttribute(($context["form"] ?? $this->getContext($context, "form")), "termsAccepted", array()), 'row', array("id" => "school_terms_accepted", "attr" => array("class" => "")));
        echo "
        ";
        // line 22
