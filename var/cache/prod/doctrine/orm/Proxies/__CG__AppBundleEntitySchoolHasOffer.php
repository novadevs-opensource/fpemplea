 ...
 */
class SchoolHasOffer extends \AppBundle\Entity\SchoolHasOffer implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\SchoolHasOffer' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\SchoolHasOffer' . "\0" . 'offer', '' . "\0" . 'AppBundle\\Entity\\SchoolHasOffer' . "\0" . 'school'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SchoolHasOffer $proxy) {
