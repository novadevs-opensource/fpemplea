...
class Message extends \AppBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'body', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'createdAt', '' . "\0" . 'AppBundle\\Entity\\Message' . "\0" . 'subject'];
        }
