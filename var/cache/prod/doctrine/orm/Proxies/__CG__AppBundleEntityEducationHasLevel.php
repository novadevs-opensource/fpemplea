 ...
 */
class EducationHasLevel extends \AppBundle\Entity\EducationHasLevel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\EducationHasLevel' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\EducationHasLevel' . "\0" . 'education', '' . "\0" . 'AppBundle\\Entity\\EducationHasLevel' . "\0" . 'level'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EducationHasLevel $proxy) {
